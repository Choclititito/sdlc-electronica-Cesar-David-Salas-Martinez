...
def get_sensor(sensor_id: str, service: SensorServiceDep) -> SensorModel:
    try:
...
def update_sensor(
    sensor_id: str, patch: SensorUpdate, service: SensorServiceDep
) -> SensorModel:
    try:
...
def delete_sensor(sensor_id: str, service: SensorServiceDep) -> None:
    try:
